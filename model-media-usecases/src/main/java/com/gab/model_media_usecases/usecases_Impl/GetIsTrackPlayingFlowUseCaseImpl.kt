...
public class GetIsTrackPlayingFlowUseCaseImpl @Inject constructor(private val repository: MediaPlayerRepository) :
    GetIsTrackPlayingFlowUseCase {
    override operator fun invoke(): StateFlow<Boolean> {
        return repository.getIsTrackPlayingFlow()
    }
}