...
public class GetIsShuffleModeSetFlowUseCaseImpl @Inject constructor(private val repository: MediaPlayerRepository) :
    GetIsShuffleModeSetFlowUseCase {
    override operator fun invoke(): StateFlow<Boolean> {
        return repository.getIsShuffleModeSetFlow()
    }
}